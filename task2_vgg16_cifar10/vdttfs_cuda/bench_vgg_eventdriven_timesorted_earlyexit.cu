// VD-TTFS time-sorted, input-generation early-exit integrator (VGG16 / CIFAR-10).
// Full 10000-image inference; see repo README/supplementary docs for the method.
// Build: nvcc cuda/bench_vgg_eventdriven_timesorted_earlyexit.cu -o cuda/bench_vgg_eventdriven_timesorted_earlyexit -O3 -Wno-deprecated-gpu-targets
// Run:   ./cuda/bench_vgg_eventdriven_timesorted_earlyexit
#include <iostream>
#include <vector>
#include <string>
#include <fstream>
